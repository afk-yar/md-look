...
- [ ] **T-01** Фабрика окон: вынести создание окна в переиспользуемую функцию `[M]`
- [ ] **T-02** IPC + жизненный цикл: новое окно вместо замены содержимого + корректное закрытие `[M]`

### Блок 2: Интеграция
- [ ] **T-03** Tray-меню, горячие клавиши, полировка `[S]`

### Блок 3: Тесты и проверка
- [ ] **T-04** Автотесты: IPC, жизненный цикл окон, build_html, Api `[M]`
